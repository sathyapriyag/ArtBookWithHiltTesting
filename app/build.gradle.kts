...
android {
    namespace = "com.learn.artbookwithhilttesting"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.learn.artbookwithhilttesting"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
       ...
       // testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner"
        ...
        testInstrumentationRunner ="com.learn.artbookwithhilttesting.HiltTestRunner"
